...
public class CompanyCard {
    ...
    /**
     * Default constructor that generates a new company card with random details.
     */
    public CompanyCard() {
    ...
    /**
     * Constructor to create a company card with specific details.
     *
     * @param cardNumber      The card number.
     * @param expirationDate  The expiration date.
     * @param cvv             The CVV.
     */
    public CompanyCard(String cardNumber, String expirationDate, String cvv) {
    ...
    /**
     * Generates an expiration date 3 years from the current date.
     *
